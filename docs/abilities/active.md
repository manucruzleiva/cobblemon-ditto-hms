...
- Aim at an **entity** → an inert copy of that creature (matching its variant/equipment) is
  spawned over you and mirrors your movement, so you actually *look* like that mob to everyone.
